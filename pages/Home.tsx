        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 h-[600px] md:h-[500px]">
            {[
              ...
              { name: Category.Casual, image: 'https://images.unsplash.com/photo-1560343090-f0409e92791a?auto=format&fit=crop&w=600&q=80', description: 'Everyday Versatility' },
            ].map((cat) => (
      ...
      <section className="relative h-[60vh] w-full flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="max-w-xl">
             <h2 className="text-5xl font-black text-white uppercase tracking-tighter mb-6 italic leading-none">Walk Your Own Path.</h2>
             <p className="text-zinc-300 text-lg mb-8">Join our community of urban explorers and creators. Share your journey with #UrbanStep.</p>
             <Link to="/stories" className="inline-block bg-white text-zinc-900 px-10 py-4 rounded-full font-black uppercase tracking-widest text-xs hover:bg-blue-600 hover:text-white transition-all">
                Explore The Journal
             </Link>
           </div>
        </div>
