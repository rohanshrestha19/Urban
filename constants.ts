...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1515955656352-a1fb3da82b00?auto=format&fit=crop&w=800&q=80',
    images: [
      'https://images.unsplash.com/photo-1515955656352-a1fb3da82b00?auto=format&fit=crop&w=800&q=80'
    ],
    sizes: [8, 9, 10, 11, 12],
    rating: 4.7,
    isSale: true
  },
  {
    ...
    category: Category.Sports,
    gender: 'Men',
    description: 'Experience pure speed with the Vortex Prime. Featuring carbon-fiber energy return and ultra-lightweight mesh.',
...

  {
    ...
    category: Category.Sneakers,
    gender: 'Women',
    description: 'Chunky, bold, and unapologetic. The Glitch defines modern street culture with its multi-layered design and vibrant accents.',
  ...
  },
  {
    ...
    category: Category.Sports,
    gender: 'Men',
    description: 'Built for the rugged unknown. The Apex Trail Pro features an ultra-grip outsole and reinforced upper for maximum durability.',
    image: 'https://images.unsplash.com/photo-1539185441755-769473a23570?auto=format&fit=crop&w=800&q=80',
    images: [
      'https://images.unsplash.com/photo-1539185441755-769473a23570?auto=format&fit=crop&w=800&q=80'
    ],
