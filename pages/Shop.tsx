...
const Shop: React.FC = () => {
  ...
  const handleVisualSearch = async (base64Image: string) => {
    ...
    try {
      ...
      // Corrected generateContent call format for multimodal input
          ...
          <aside className="w-full lg:w-72 flex-shrink-0 space-y-12">
            ...
            <div className="bg-blue-600 rounded-[2.5rem] p-10 text-white relative overflow-hidden group">
              <div className="relative z-10">
                ...
                <Link to="/size-guide" className="bg-white text-blue-600 px-6 py-3 rounded-full text-xs font-black uppercase tracking-widest hover:bg-zinc-900 hover:text-white transition-all inline-block">
                  View Guide
                </Link>
              </div>
