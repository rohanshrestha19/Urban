      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-3">
            {/* Compare Icon */}
            <Link to="/compare" className="relative p-2 group block" title="Compare Products">
            ...
            {/* Wishlist Icon */}
            <Link to="/wishlist" className="relative p-2 group block" title="Wishlist">
            ...
            >
              <Link to="/cart" className="relative p-2 group block" title="Shopping Cart">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-zinc-900 group-hover:text-blue-600 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
